...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Countryfragment.returnCountryAndState, SetLocation.returnLocation {
    ...
    private void loadPostUserFragment() {
